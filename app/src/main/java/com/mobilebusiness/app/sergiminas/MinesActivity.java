...
public class MinesActivity extends AppCompatActivity {
   ...
   // private TableLayout mineField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get table of mines
        mineField = (GridLayout)findViewById(R.id.MineField);
        mineField.setUseDefaultMargins(false);
        mineField.setAlignmentMode(GridLayout.ALIGN_BOUNDS);
        mineField.setRowOrderPreserved(false);
